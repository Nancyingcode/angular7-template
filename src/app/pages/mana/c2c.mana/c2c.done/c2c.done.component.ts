...
@Component({
  selector   : 'app-c2c-done',
  templateUrl: './c2c.done.component.html',
  styleUrls  : ['./c2c.done.component.less']
})

export class C2cDoneComponent implements OnInit {
  ...
  setData(data: any): void {
    this.cs.getDoneOrderList(data).subscribe(res => this.patchValue(res));
  }

  patchValue( { list, count }: DefaultDataFormate ): void {
    this.data = {
      title : ['订单号', '卖家手机号', '买家手机号', '出售数量', 'USDT单价', 'USDT总价', '交易时间'],
