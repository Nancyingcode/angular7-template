...
@Component({
  selector: 'app-currency-doneeth-detail',
  templateUrl: './done.eth.detail.html',
  styleUrls: ['./done.eth.detail.less']
})

export class CurrencyDoneEthDetailComponent {
  // public data: any;
