...
@Component({
  selector: 'app-currency-doneimacc-detail',
  templateUrl: './done.imacc.detail.html',
  styleUrls: ['./done.imacc.detail.less']
})

export class CurrencyDoneImaccDetailComponent {
  // public data: any;
