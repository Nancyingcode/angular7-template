...
@Component({
  selector: 'app-currency-sellingimacc-detail',
  templateUrl: './selling.imacc.detail.html',
  styleUrls: ['./selling.imacc.detail.less']
})

export class CurrencySellingImaccDetailComponent {
  // public data: any;
