...
const { currencySellingImaccDetail } = Config.userMana;
...
@Component({
  selector: 'app-currency-selling-imacc',
  templateUrl: './currency.selling.imacc.html',
  styleUrls: ['./currency.selling.imacc.less']
})

export class CurrencySellingImaccComponent implements OnInit {
  ...
  detail = ({ orderId }) => {
    this.router.navigate([currencySellingImaccDetail, { orderId }]);
  }
}
