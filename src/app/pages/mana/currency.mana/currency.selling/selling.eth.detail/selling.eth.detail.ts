...
@Component({
  selector: 'app-currency-sellingeth-detail',
  templateUrl: './selling.eth.detail.html',
  styleUrls: ['./selling.eth.detail.less']
})

export class CurrencySellingEthDetailComponent {
  // public data: any;
