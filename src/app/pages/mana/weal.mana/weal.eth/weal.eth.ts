...
import { WealService } from '../weal.ustd';
import {
  checkReq,
  itemStatus,
  showConfirm,
...
const console = new Log('WealEthComponent');
...
@Component({
  selector: 'app-weal-eth',
  templateUrl: './weal.eth.html',
  styleUrls: ['./weal.eth.less']
})

export class WealEthComponent implements OnInit {
  ...
  async ngOnInit(): Promise<any> {
    const data = await this.getData({ ...defaultWealData, type: 'ETH' });
