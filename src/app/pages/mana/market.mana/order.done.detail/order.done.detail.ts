...
@Component({
  selector: 'app-market-orderdone-detail',
  templateUrl: './order.done.detail.html',
  styleUrls: ['./order.done.detail.less']
})

export class MarketOrderDoneDetailComponent implements OnInit {
  public data: any;
  ...
  async getData(data: any): Promise<any> {
    return await this.ms.getDoneDetail(data);
  }
